...
var ErrorToken = Token{Type: tokenError}
...
var baseDataType = map[string]struct{}{
	"bool":       {},
	"uint8":      {},
	"uint16":     {},
	"uint32":     {},
...
// IsBaseType returns true if the given ident is a base data type.
func IsBaseType(ident string) bool {
	_, ok := baseDataType[ident]
	return ok
}
