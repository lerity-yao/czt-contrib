...
var templates = map[string]string{
	...
	workerTemplateFile:  workerTemplate,
	typesTemplateFile:   typesTemplate,
}

// Category returns the category of the cron files.
...
// GenTemplates generates cron template files.
