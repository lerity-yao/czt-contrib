...
// GoCronCommand gen go cron project files from command line
func GoCronCommand(_ *cobra.Command, _ []string) error {
...
// DoGenProject gen go project files with cron file
func DoGenProject(apiFile, dir, style string, withTest bool) error {
	...
	if err := genWorker(dir, rootPkg, cfg, api); err != nil {
		return err
	}
