...
public class CztctlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ATDOC", "ATHANDLER", "ATSERVER", "ATCRON", "ATCRONRETRY", "SYNTAX", 
			...
			"RAW_STRING", "INT", "ID", "LetterOrDigit", "EscapeSequence", "HexDigit", 
			"Letter"
		};
	}
	...
	public CztctlLexer(CharStream input) {
		super(input);
